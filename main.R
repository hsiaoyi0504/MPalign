...
exp2 <- function(cell_features_time_1, cell_features_time_2, time_1, time_2){
  ...
  count_time_1 <- temp %>% filter(time_point == time_1) %>% count(cluster, sort=TRUE, .drop=FALSE)
  count_time_2 <- temp %>% filter(time_point == time_2) %>% count(cluster, sort=TRUE, .drop=FALSE)
  print(count_time_1)
...
cat("\nexp2:\n")
cat("uninfected -> 8hrs\n")
exp2(cell_features_uninfected, cell_features_8hrs, "Uninfected", "8 hours")
cat("uninfected -> 24hrs\n")
exp2(cell_features_uninfected, cell_features_24hrs, "Uninfected", "24 hours")
cat("uninfected -> 30hrs\n")
exp2(cell_features_uninfected, cell_features_30hrs, "Uninfected", "30 hours")
cat("uninfected -> 36hrs\n")
exp2(cell_features_uninfected, cell_features_36hrs, "Uninfected", "36 hours")
cat("uninfected -> 48hrs\n")
exp2(cell_features_uninfected, cell_features_48hrs, "Uninfected", "48 hours")
cat("8hrs -> 24hrs\n")
exp2(cell_features_8hrs, cell_features_24hrs, "8 hours", "24 hours")
cat("8hrs -> 30hrs\n")
exp2(cell_features_8hrs, cell_features_30hrs, "8 hours", "30 hours")
cat("8hrs -> 36hrs\n")
exp2(cell_features_8hrs, cell_features_36hrs, "8 hours", "36 hours")
cat("8hrs -> 48hrs\n")
exp2(cell_features_8hrs, cell_features_48hrs, "8 hours", "48 hours")
cat("24hrs -> 30hrs\n")
exp2(cell_features_24hrs, cell_features_30hrs, "24 hours", "30 hours")
cat("24hrs -> 36hrs\n")
exp2(cell_features_24hrs, cell_features_36hrs, "24 hours", "36 hours")
cat("24hrs -> 48hrs\n")
exp2(cell_features_24hrs, cell_features_48hrs, "24 hours", "48 hours")
cat("30rs -> 36hrs\n")
exp2(cell_features_30hrs, cell_features_36hrs, "30 hours", "36 hours")
cat("30rs -> 48hrs\n")
exp2(cell_features_30hrs, cell_features_48hrs, "30 hours", "48 hours")
cat("36rs -> 36hrs\n")
exp2(cell_features_36hrs, cell_features_48hrs, "36 hours", "48 hours")
